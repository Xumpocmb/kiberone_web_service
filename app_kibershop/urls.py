...
from app_kibershop.views import catalog_view, cart_view, add_to_cart, remove_from_cart, cart_minus, cart_plus, make_order, profile_page, get_orders_list
...
urlpatterns = [
    ...
    path("orders_list/", get_orders_list, name="orders_list"),
]
